        ...
        >
          {type === 'images/' ? imageUrl ?
            <div style={{position: 'relative'}}>
              { showReview ?
                <Icon type="delete" style={{position: 'absolute',top: `${this.props.small?'35px':'70px'}`,right: `${this.props.small?'30px':'90px'}`,color:'#fff'}}
                      onClick={(e)=>{
                        e.stopPropagation();
                        this.props.onChange('');
              ...
              { showReview ?
                <Icon type="eye-o" style={{position: 'absolute',top: `${this.props.small?'35px':'70px'}`,left: `${this.props.small?'30px':'90px'}`,color:'#fff'}}
                      onClick={(e)=>{
                        e.stopPropagation();
