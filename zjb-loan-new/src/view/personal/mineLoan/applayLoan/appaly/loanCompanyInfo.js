                ...
                this.props.form.validateFieldsAndScroll((error, values) => {
                    if (!error) {
                        ...
                        if (this.props.saveNO !== nextProps.saveNO) {
                            this.props.changeData('company', values, true, true);
                        } else {
                            if (this.props.commit !== nextProps.commit) {
                                this.props.changeData('company', values, true, false, true);
                            } else {
                                this.props.changeData('company', values, true, false);
                            }
                        }
                    } else {
                        this.props.changeData('company', values, false);
                    }
                });
            }
        }
            ...
            <div className="applone-info">
                ...
                <div>
                    ...
                    <div style={{ marginBottom: 20 }} className="third_company_info  ">
                        <Form layout="vertical" hideRequiredMark style={{ marginTop: 29 }}>
                            <Row gutter={16}>
                                ...
                                <Form.Item >
                                    <div>
                                        <Tooltip title={<p>填写说明：<br />
                                            ...
                                            <Icon type="question-circle-o" className='filler_uploads' style={{ left: 150, top: -26 }} /></Tooltip></div>
...
。</p>}><Icon type="question-circle-o" className='filler_uploads' style={{ left: 120, top: -26 }} /></Tooltip></div>
                            ...
                            <Col lg={8} md={12} sm={24}>
                                <Form.Item >
                                    <div><Tooltip title={<p>填写说明：<br />1.如有多个文件可打包上传。</p>}><Icon type="question-circle-o"
                                        className='filler_uploads' style={{ left: 170, top: -26 }} /></Tooltip></div>
                            ...
                            <Col lg={8} md={12} sm={24}>
                                <Form.Item >
                                    <div><Tooltip title={<p>填写说明：<br />1、包括公司章程、验资报告等。<br />2.如有多个文件可打包上传。</p>}>
                                        <Icon type="question-circle-o" className='filler_uploads' style={{ left: 130, top: -26 }} /></Tooltip></div>
                                ...
                                <Form.Item >
                                    <div>
                                        <Tooltip title={<p>填写说明：<br />
                                            ...
                                            <Icon type="question-circle-o" className='filler_uploads' style={{ left: 120, top: -26 }} /></Tooltip>
                                    </div>
                                    {getFieldDecorator('fother_file1', {
                                        //   initialValue: data.fother_file1 ? JSON.parse(data.fother_file1) : [],
                                        rules: [],
                            ...
                            <Col lg={8} md={12} sm={24}>
                                <Form.Item >
                                    <div><Tooltip title={<p>填写说明：<br />1、银行代缴有关凭证需加盖银行签章。<br />
                                        2.如有多个文件可打包上传。</p>}><Icon type="question-circle-o" className='filler_uploads' style={{ left: 240, top: -26 }} /></Tooltip></div>
